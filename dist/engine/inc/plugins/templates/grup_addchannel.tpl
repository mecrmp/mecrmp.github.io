...
<link rel="stylesheet" type="text/css"  href="engine/skins/grabber/css/uni.css" />
<script src="engine/skins/grabber/js/uni.js" type="text/javascript"></script>
...
$(document).ready(function(){
    $(".cat_select").chosen({allow_single_deselect:true, no_results_text: "{nosearch}"});
	$("input:text, .edit, .load_img, textarea").uniform();
...
<!-- Конец -->
 ...
 <script type="text/javascript" src="engine/skins/grabber/js/tabs.js"></script>
 <script type="text/javascript">
   initTabs('rss_panel', Array('{Options}', '{Images}', '{Dop_Options}', '{Visualization}', '{Filter_Authorization}', '{Authors}', '{For_HTML}', '{Replacements}'),0, '100%');
 </script>
