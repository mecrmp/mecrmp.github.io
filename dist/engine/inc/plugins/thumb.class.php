...
class rss_thumbnail {
	...
	function insert_watermark($min_image) {
		...
		if ($this->margin == '')$margin = 7;else $margin =  $this->margin;
		
		if ($this->watermark_image_light == '' and $this->watermark_image_dark == ''){
		...
		if ($this->x == '2')$watermark_x = $margin;
		elseif ($this->x == '1')$watermark_x = ($image_width  - $watermark_width)/2;
		else $watermark_x = $image_width - $margin - $watermark_width;

		if ($this->y == '2')$watermark_y =  $margin ;
		elseif ($this->y == '1')$watermark_y = ($image_height - $watermark_height)/2;
		else $watermark_y = $image_height - $margin - $watermark_height;
