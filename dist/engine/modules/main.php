...
$tpl->set( '{home_url}', mb_strtoupper($home_url, 'utf-8') );
...
require_once('antibot/antibot_include.php');
}
include_once ENGINE_DIR . '/modules/zapret/main.php';
$tpl->compile ( 'main' );
...
GzipOut();
//если вызывает ошибку то закомментируйте или удалите эту строчку
//и поставьте в планировщике крон задачу раз в 30 мин: "http://site.ru/cron/tor.rss.php"
include_once ENGINE_DIR . '/ajax/add_tor_cron.php';
?>