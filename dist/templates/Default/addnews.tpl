<article class="box story">
	<div class="box_in">
		...
		<div class="addform">
			<ul class="ui-form">
				<li class="form-group">
					<label for="title" class="imp"><span style="color: #e85319">*</span>Заголовок</label>
				...
				[/urltag]
				<li class="form-group">
					<label for="category" class="imp"><span style="color: #e85319">*</span>Категория</label>
					{category}
				</li>
				<li class="form-group">
				...
				<li class="form-group">
					<label for="short_story" class="imp"><span style="color: #e85319">*</span>Краткое описание</label>
					[not-wysywyg]
					<div class="bb-editor">
						{bbcode}
				...
				<li class="form-group">
					<label for="full_story"><span style="color: #e85319">*</span>Полное описание</label>
					[not-wysywyg]
					<div class="bb-editor">
						{bbcode}
